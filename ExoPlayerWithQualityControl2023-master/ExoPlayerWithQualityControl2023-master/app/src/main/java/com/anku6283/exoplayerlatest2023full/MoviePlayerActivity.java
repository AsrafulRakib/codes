...
//        urlVideoMain = BaseUrl + "movies/" + cat + "/" + id + "/" + bundle.getString("Video");
        ...
        String url4 = "https://cph-p2p-msl.akamaized.net/hls/live/2000341/test/master.m3u8";
        String channeliUrl = "https://cdn.appv.jagobd.com:444/cZMLmVyX3RpbEU9Mi8xNy8yMDE0GIDU6RgzQ6NTAgdEoaeFzbF92YWxIZTO0U0ezN1IzMyfvcGVMZEJCTEFWeVN3PTOmdFsaWRtaW51aiPhnPTI/channeli-8-org.stream/playlist.m3u8";

        mediaItem = MediaItem.fromUri(Uri.parse(url4));
